...
parser.add_argument('--logs_dir', type=str, default='assets/ckpt/branched_resnet_gated_segmentation/flat_to_branch/branch_point_20/keep_0.1')
...
# logs_dir = f'assets/ckpt/branched_resnet_gated_segmentation/init_wts_flat_to_branch/branch_point_{branch_point}/keep_{keep_ratio}' 
logs_dir = f'assets/ckpt/models/resnet34/branched/segmentation/branch_point_{branch_point}/local_prune_uniform/training/run_2/keep_{keep_ratio}'
...
init_weights_path = os.path.join(config_dir, f'init_weights_branched_{branch_point}_config.pth')
init_weights = torch_load('init_branched_weights', init_weights_path)
...
'''python train_branched_model.py --keep_ratio=0.1 --testing'''